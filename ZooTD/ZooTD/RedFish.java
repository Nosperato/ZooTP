 ...
 */
public class RedFish extends Other implements Marine{
    public RedFish(String name, char sex, int weight, int height, int age, int durationGestation) {
    ...
    public Other lay() {
        if(this.getSex() == 'm')
            ...
            return (RedFish) factory.createAnimal("Poisson rouge", this.getName(), s, 2, 80, 0, this.getDurationGestation());
        }
        return null;
    }
    ...
    @Override
    public void swim() {
        this.getViewOther().showSwimRedFish(this.getName());
    }
